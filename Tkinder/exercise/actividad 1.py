...
numero1 = IntVar()
numero2 = IntVar()
titulo = Label(text="Operaciones",font=("Algerian",15)).place(x=180,y=30)
nu1 = Entry(textvariable=numero1).place(width=130,x=180,y=60)
nu2 = Entry(textvariable=numero2).place(width=130,x=180,y=90)
bsumar = Button(text="sumar",command=sumar).place(width=80, x=50,y=120)
botonre = Button(text="restar",command=restar).place(width=80, x=150,y=120)
